...
!(function (e, t) {
    ...
    var n = {
        ...
        find: function (e) {
            for (var t = this, a = [], i = 0; i < this.length; i += 1)
                for (
                    var s = t[i].querySelectorAll(e), n = 0;
                    n < s.length;
                    n += 1
                )
                    a.push(s[n]);
    ...
    (c.prototype.on = function (e, t) {
        ...
        (c.installModule = function (e) {
            ...
            var s =
                e.name ||
                Object.keys(i.prototype.modules).length + "_" + l.now();
            return (
    ...
    var h = {
            ...
            updateSlidesClasses: function () {
                ...
                a.loop &&
                    0 === l.length &&
                    (l = t.eq(0)).addClass(a.slideNextClass);
                var d = o
                ...
                a.loop &&
                    0 === d.length &&
                    (d = t.eq(-1)).addClass(a.slidePrevClass),
                    a.loop &&
            ...
            return {
                ...
                ieTouch:
                    (s.navigator.msPointerEnabled &&
                        s.navigator.msMaxTouchPoints > 1) ||
        ...
        b = {
            loopCreate: function () {
                ...
                for (var u = l.length - 1; u >= 0; u -= 1)
                    i.prepend(
                        e(l[u].cloneNode(!0)).addClass(a.slideDuplicateClass)
                    );
            },
            loopFix: function () {
                var e,
        ...
        x = (function () {
            ...
            if (
                ...
                (t.webView =
                    (o || r || n) && e.match(/.*AppleWebKit(?!.*Safari)/i)),
                t.os && "ios" === t.os)
            ) {
        ...
        T = function (t) {
            ...
            if (
                ...
                if (
                    s.noSwiping &&
                    e(n.target).closest("." + s.noSwipingClass)[0]
                )
                    a.allowClick = !0;
                ...
                detachEvents: function () {
                    ...
                    if (m.ie)
                        r.removeEventListener(a.start, e.onTouchStart, !1),
                            (p.touch ? r : d).removeEventListener(
                                a.move,
                                e.onTouchMove,
                                n
                            ),
                    ...
                    if (s && (!s || 0 !== Object.keys(s).length)) {
                        ...
                        if (r && e.currentBreakpoint !== r) {
                            var n = r in s ? s[r] : e.originalParams,
                                o =
                                    i.loop &&
                                    n.slidesPerView !== i.slidesPerView;
                            l.extend(e.params, n),
                                l.extend(e, {
                        ...
                        l.extend(c, {
                            ...
                            touchEvents: (function () {
                                ...
                                return (
                                    ...
                                    {
                                        start:
                                            p.touch || !c.params.simulateTouch
                                                ? e[0]
                                                : t[0],
                                        move:
                                            p.touch || !c.params.simulateTouch
        ...
        Y = {
                    ...
                    t.isHorizontal()
                        ? ((37 !== i && 39 !== i) ||
                              (a.preventDefault
                                  ? a.preventDefault()
                                  : (a.returnValue = !1)),
                          ((39 === i && !t.rtl) || (37 === i && t.rtl)) &&
                              t.slideNext(),
                          ((37 === i && !t.rtl) || (39 === i && t.rtl)) &&
                              t.slidePrev())
                        : ((38 !== i && 40 !== i) ||
                              (a.preventDefault
                                  ? a.preventDefault()
            ...
            enable: function () {
                var t = this;
                t.keyboard.enabled ||
                    (e(d).on("keydown", t.keyboard.handle),
                    (t.keyboard.enabled = !0));
            },
            disable: function () {
                var t = this;
                t.keyboard.enabled &&
                    (e(d).off("keydown", t.keyboard.handle),
                ...
                if (a.el) {
                    ...
                    0 !== i.length &&
                        ...
                        "bullets" === a.type &&
                            a.dynamicBullets &&
                            i.addClass(
                                "" + a.modifierClass + a.type + "-dynamic"
                            ),
                        a.clickable &&
                            i.on("click", "." + a.bulletClass, function (a) {
                                a.preventDefault();
                                var i =
                                    e(this).index() * t.params.slidesPerGroup;
            ...
            enableDraggable: function () {
                ...
                if (t.params.scrollbar.el) {
                    ...
                    a.on(t.scrollbar.dragEvents.start, t.scrollbar.onDragStart),
                        e(i).on(
                            t.scrollbar.dragEvents.move,
                            t.scrollbar.onDragMove
                        ),
                        e(i).on(
                            t.scrollbar.dragEvents.end,
                            t.scrollbar.onDragEnd
                        );
                }
            },
                ...
                s.$imageEl &&
                    ...
                    i.scale < a.minRatio &&
                        (i.scale =
                            a.minRatio +
                            1 -
                            Math.pow(a.minRatio - i.scale + 1, 0.5)),
                    s.$imageEl.transform(
                ...
                if (!a.enabled) {
                    ...
                    p.gestures
                        ...
                        t.slides.each(function (i, s) {
                            var r = e(s);
                            r.find("." + t.params.zoom.containerClass).length >
                                0 && r.on(t.touchEvents.move, a.onTouchMove);
                        });
                }
            },
            disable: function () {
                ...
                if (a.enabled) {
                    ...
                    p.gestures
                        ...
                        t.slides.each(function (i, s) {
                            var r = e(s);
                            r.find("." + t.params.zoom.containerClass).length >
                                0 && r.off(t.touchEvents.move, a.onTouchMove);
                        });
                }
            },
        },
                ...
                l.extend(e, {
                    controller: {
                        ...
                        getInterpolateFunction:
                            te.getInterpolateFunction.bind(e),
                ...
                for (var t = this, a = t.slides, i = 0; i < a.length; i += 1) {
                    ...
                    if (
                        (t.isHorizontal()
                            ...
                            : ((d = l), (l = 0), (o = -n), (n = 0)),
                        (s[0].style.zIndex =
                            -Math.abs(Math.round(r)) + a.length),
