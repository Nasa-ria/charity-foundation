...
class AdminDashboardController extends Controller
{
    ...
    public function  to_do(){
        return view('dashboard.admin.pages.To-Do.todo');
    }
    
    public function  to_doform(){
        return view('dashboard.admin.pages.To-do.taskForm');
    }
    ...
    public function  event(){
        return view('dashboard.admin.pages.forms.event');
    }
    
    public function todolist(){
        return view('dashboard.admin.pages.todolist');
    }
    ...
    public function form(){
        return view('dashboard.admin.pages.iframe');
    }
    public function blogform(){
        return view('dashboard.admin.pages.form.general');
    } 
    public function layoutboxed(){
        return view('dashboard.admin.pages.layout.boxed');
    }
