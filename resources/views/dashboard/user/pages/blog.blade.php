            ...
            <div class="col col-md-8">
                <div class="tp-tp-blog-content">
                    <div class="post format-standard-image">
                        ...
                        <a href="{{route('user.singleBlog')}}" class="read-more">Read More...</a>
                    </div>
                    ...
                    <div class="widget recent-post-widget">
                        ...
                        <div class="posts">
                            <div class="post">
                                ...
                                <div class="details">
                                    <h4><a href="{{route('user.singleBlog')}}">Many Children are suffering a lot for food.</a></h4>
                            ...
                            <div class="post">
                                ...
                                <div class="details">
                                    <h4><a href="{{route('user.singleBlog')}}">Be kind for the poor people and the kids.</a></h4>
                                    <span class="date">22 Sep 2021</span>
                                </div>
                            </div>
                            <div class="post">
                                ...
                                <div class="details">
                                    <h4><a href="{{route('user.singleBlog')}}">Be soft and kind for the poor people.</a></h4>
                                    <span class="date">22 Sep 2021</span>
                                </div>
                            </div>
                        </div>
